...
<?php #includes the header file on the index
include "templates/header.php"; 
include "../public/body.php"; ?>

    <div class="row">
        <div class="col text-right"><h2>Sign Up</h2>
        <p>Please fill this form to create an account.</p></div>
        <div class="col">
        
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label><p>Enter a username:</p></label>
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label><p>Confirm  your password:</p></label>
